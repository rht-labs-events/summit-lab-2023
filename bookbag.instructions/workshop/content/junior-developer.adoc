...
[start=3]
. The first time you access this GitLab instance from RH OpenShift Dev Spaces, it will prompt to authorize the use of your account for the OAuth integration. Click on the `Authorize` button to continue. 
