...
[start=4]
. Welcome to RH OpenShift Dev Spaces! If you are seeing prompts to trust the author, etc. please click "yes" and proceeed to you see an IDE like the screenshot below. 
